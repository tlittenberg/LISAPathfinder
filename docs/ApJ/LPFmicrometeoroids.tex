...
\caption{Micrometeoroid impacts visualized along LPF's trajectory in Earth Mean Equatorial (J2000) coordinates.  The gray line shows LPF's counterclockwise trajectory from 2016-01-01 through 2017-07-31 with the times searched for impacts in the LTP, DRS, and hybrid configurations in blue, pink, and green respectively. Impacts are indicated by yellow circles. \label{fig:ephemeris}}
\end{figure}
