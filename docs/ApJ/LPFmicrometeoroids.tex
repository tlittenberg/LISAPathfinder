...
\begin{figure}
\gridline{\fig{figures/rawImpact.eps}{1.0\columnwidth}{(a) LPF Telemetry}}
 \gridline{\fig{figures/reconstructedImpact.eps}{1.0\columnwidth}{(b) Equivalent free-body acceleration }}
