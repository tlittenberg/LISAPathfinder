...
\begin{figure}
\gridline{\fig{figures/HTC.png}{0.9\columnwidth}{(a) Halley-Type Comets (HTCs)}}
\gridline{\fig{figures/JFC.png}{0.9\columnwidth}{(b) Jupiter-Family Comets (JFCs)}}
\gridline{\fig{figures/OCC.png}{0.9\columnwidth}{(c) Oort Cloud Comets (OCCs)}}
...
\begin{figure}[h!]
\gridline{
\fig{figures/goodDualCorner.eps}{\columnwidth}{}}
...
\gridline{
\fig{figures/goodFlat.eps}{\columnwidth}{(b) Impact location on S/C}}
...
\begin{figure}[h!]
\gridline{
\fig{figures/badDualCorner.eps}{\columnwidth}{}}
