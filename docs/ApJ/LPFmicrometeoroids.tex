...
\caption{Timeline of impact events during LPF. The yellow dots show the impact times. The vertical bars denote the times included in the search with blue representing LTP, red DRS, and purple the mixed mode. \label{fig:timeline}}
\end{figure}
