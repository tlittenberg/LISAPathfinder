...
groupParams{5} = [...
  LPFParam.COLDGAS_A_01_RX,...
  LPFParam.COLDGAS_A_01_RY,...
  LPFParam.COLDGAS_A_01_RZ,...
  LPFParam.COLDGAS_A_02_RX,...
  LPFParam.COLDGAS_A_02_RY,...
  LPFParam.COLDGAS_A_02_RZ,...
  LPFParam.COLDGAS_A_03_RX,...
  LPFParam.COLDGAS_A_03_RY,...
  LPFParam.COLDGAS_A_03_RZ,...
  LPFParam.COLDGAS_A_04_RX,...
  LPFParam.COLDGAS_A_04_RY,...
  LPFParam.COLDGAS_A_04_RZ,...
  LPFParam.COLDGAS_A_05_RX,...
  LPFParam.COLDGAS_A_05_RY,...
  LPFParam.COLDGAS_A_05_RZ,...
  LPFParam.COLDGAS_A_06_RX,...
  LPFParam.COLDGAS_A_06_RY,...
  LPFParam.COLDGAS_A_06_RZ...
  ];

% Cold Gas directions (these are for the A-side)
groupParams{6} = [...
  LPFParam.COLDGAS_A_01_ELV,...
  LPFParam.COLDGAS_A_01_AZM,...
  LPFParam.COLDGAS_A_02_ELV,...
  LPFParam.COLDGAS_A_02_AZM,...
  LPFParam.COLDGAS_A_03_ELV,...
  LPFParam.COLDGAS_A_03_AZM,...
  LPFParam.COLDGAS_A_04_ELV,...
  LPFParam.COLDGAS_A_04_AZM,...
  LPFParam.COLDGAS_A_05_ELV,...
  LPFParam.COLDGAS_A_05_AZM,...
  LPFParam.COLDGAS_A_06_ELV,...
  LPFParam.COLDGAS_A_06_AZM...
  ];

% Cold Gas Positions (these are for the B-side)
groupParams{7} = [...
  LPFParam.COLDGAS_B_01_RX,...
  LPFParam.COLDGAS_B_01_RY,...
  LPFParam.COLDGAS_B_01_RZ,...
  LPFParam.COLDGAS_B_02_RX,...
  LPFParam.COLDGAS_B_02_RY,...
  LPFParam.COLDGAS_B_02_RZ,...
  LPFParam.COLDGAS_B_03_RX,...
  LPFParam.COLDGAS_B_03_RY,...
  LPFParam.COLDGAS_B_03_RZ,...
  LPFParam.COLDGAS_B_04_RX,...
  LPFParam.COLDGAS_B_04_RY,...
  LPFParam.COLDGAS_B_04_RZ,...
  LPFParam.COLDGAS_B_05_RX,...
  LPFParam.COLDGAS_B_05_RY,...
  LPFParam.COLDGAS_B_05_RZ,...
  LPFParam.COLDGAS_B_06_RX,...
  LPFParam.COLDGAS_B_06_RY,...
  LPFParam.COLDGAS_B_06_RZ...
  ];


% Cold Gas directions (these are for the B-side)
groupParams{8} = [...
  LPFParam.COLDGAS_B_01_ELV,...
  LPFParam.COLDGAS_B_01_AZM,...
  LPFParam.COLDGAS_B_02_ELV,...
  LPFParam.COLDGAS_B_02_AZM,...
  LPFParam.COLDGAS_B_03_ELV,...
  LPFParam.COLDGAS_B_03_AZM,...
  LPFParam.COLDGAS_B_04_ELV,...
  LPFParam.COLDGAS_B_04_AZM,...
  LPFParam.COLDGAS_B_05_ELV,...
  LPFParam.COLDGAS_B_05_AZM,...
  LPFParam.COLDGAS_B_06_ELV,...
  LPFParam.COLDGAS_B_06_AZM...
  ];
...
% Typical noise levels
groupParams{11} = getNoiseParameters();
